    ...
    return (
      <div className=" flex items-center justify-center">
        <div className="bg-red-200 text-red-700 p-6 rounded-lg shadow-md">
          ...
          <p className="mt-2">You must be logged in to view this Profile page.</p>
  ...
  return (
    <div className=" bg-gray-100 flex flex-col items-center justify-center">
      <div className="shadow-lg rounded-lg overflow-hidden w-full max-w-4xl">
        ...
        {/* Cover photo */}
        <div className="relative h-56 bg-cover bg-center" style={{ backgroundImage: "url('https://i.ibb.co.com/9TfxBsP/download.png')" }}>
        ...
        <div className="border-t mt-6">
          <div className="p-6 text-center">
            <p className="text-gray-700">Cooking is an art and you're the artist! - Favorite quote 😉</p>
          </div>
        </div>
      </div>
    </div>
