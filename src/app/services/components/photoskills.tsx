...
const Photoskills = () => {
  return (
    <div className="w-full h-screen lg:h-[80vh] sm:h-[60vh] xs:h-[50vh] flex items-center justify-center rounded-full bg-circularLight dark:bg-circularDark relative flex-wrap">
    
      <div className=" font-semibold rounded-full bg-[#00BBA6] text-light dark:text-dark p-2 shadow-md cursor-pointer xs:text-xs">
        Software
      </div>
      <div className="absolute transform translate-x-[-25vw] translate-y-[2vw]  font-semibold rounded-full bg-[#00BBA6] text-light py-3 px-6 shadow-md cursor-pointer xs:text-xs">
        MERN
      </div>
      
      <div className="absolute transform translate-x-[-5vw] translate-y-[-11vw]  font-semibold rounded-full bg-[#00BBA6] text-light py-3 px-6 shadow-md cursor-pointer xs:text-xs">
        PERN
      </div>
